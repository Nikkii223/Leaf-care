<nav class="navbar-default navbar-static-top" role="navigation">
             <div class="navbar-header">
               ...
               <h1> <a class="navbar-brand" href="dashboard.php">Patient</a></h1>         
			   </div>
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="drop-men" >
		        <ul class=" nav_1">
					...
					<li class="dropdown">
		              <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><?php echo $_SESSION['p_email'];?><i class="caret"></i></span><img src="images/admin.png"></a>
		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="user_profile.php" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i> <span class="nav-label">User Profile</span> </a>
                    </li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="appionment_list.php" class=" hvr-bounce-to-right"><i class="fa fa-hospital-o nav_icon"></i> <span class="nav-label">Appionment List</span> </a>
                    </li>
                     <li>
