...
<html>
<head>
<title>Doctor Consult Admin | Doctor List</title>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      	...
      	{
      		?>
      		<a href="common.php?a_d_id=<?php echo $row['d_id'];?>">Allow</a>
      	<?php
      }
      	else
      	{
      		?>
      		<a href="common.php?b_d_id=<?php echo $row['d_id'];?>">Block</a>
      <?php
      	}
      ?>
      	
      </td>
      <td><a href="common.php?d_d_id=<?php echo $row['d_id'];?>"> Delete</a> | <a href="doctor_profile.php?v_d_id=<?php echo $row['d_id'];?>"> View Detail</a></td>
    </tr>
   <?php
   $i++;
   }
