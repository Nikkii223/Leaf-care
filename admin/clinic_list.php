  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      	...
      	{
      		?>
      		<a href="common.php?a_c_id=<?php echo $row['c_id'];?>">Allow</a>
      	<?php
      }
      	else
      	{
      		?>
      		<a href="common.php?b_c_id=<?php echo $row['c_id'];?>">Block</a>
      <?php
      	}
      ?>
      	
      </td>
      <td><a href="common.php?d_c_id=<?php echo $row['c_id'];?>"> Delete</a> | <a href="clinic_profile.php?v_c_id=<?php echo $row['c_id'];?>"> View Detail</a></td>
    </tr>
   <?php
   $i++;
   }
