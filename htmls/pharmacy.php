...
<div class="container" style="margin-top: 10px;">
  <h3 style="text-align: center;">Pharmacy List</h3>
                    ...
                    <div class="thumbnail card">
                        ...
                        <div class="caption card-body">
                            <h4 class="group card-title inner list-group-item-heading">
                                Pharmacy Name:- <?php echo $row['Phar_Name'];?></h4>
                            <p class="group inner list-group-item-text">
                                Pharmacy Address:- <?php echo $row['Phar_Location'] ;?>.</p>
                                  <p class="group inner list-group-item-text">
                                Pharmacy Contact:- <?php echo $row['PhoneNumber'] ;?>.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <p class="lead">
                                        <?php echo $row['StartingHours'] ;?></p>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <p class="lead">
                                        <?php echo $row['EndingHours'] ;?></p>
                                </div>
                            </div>
