<?php
include 'conn.php';
$sql="SELECT * FROM `blog`,registerdoctor where registerdoctor.d_id=blog.d_id";
    		...
    		<!-- <div class="col-md-4">
			 ...
			 <div class="item col-xs-4 col-lg-4">
                    <div class="thumbnail card">
                        <div class="img-event">
                            <img class="group list-group-image img-fluid" src="<?php echo $row['b_image'] ;?>" alt="" />
                        </div>
                        <div class="caption card-body">
                            <h4 class="group card-title inner list-group-item-heading">
                                Blog Title:- <?php echo $row['b_title'];?></h4>
                            <p class="group inner list-group-item-text">
                                Blog Description:- <?php echo $row['b_desc'] ;?>.</p>
                                  <p class="group inner list-group-item-text">
                                Doctor Name:- <?php echo $row['D_Fname'].$row['D_Lname'] ;?>.</p>
