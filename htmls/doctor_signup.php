                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="specialty" class="col-form-label">Doctor Registration Number</label>
                                    <input type="text" class="form-control" id="doc_reg_number" placeholder="Doctor Registration Number ?" name="doc_reg_number" value="" required>
                                </div>
                          <div class="form-group">
                                    <label for="specialty" class="col-form-label">Doctor Documnet For Proof</label>
                                    <input type="file" class="form-control" id="doc_document"  name="doc_document" value="" required>
                                </div>
