                    ...
                    <div class="thumbnail card">
                        ...
                        <div class="caption card-body">
                            <h4 class="group card-title inner list-group-item-heading">
                                Clinic Name:- <?php echo $row['Clinic_Name'];?></h4>
                            <p class="group inner list-group-item-text">
                                Clinic Address:- <?php echo $row['Location'] ;?>.</p>
                                  <p class="group inner list-group-item-text">
                                Clinic Contact:- <?php echo $row['phone'] ;?>.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <p class="lead">
                                        <?php echo $row['Starting_Hours'] ;?></p>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <p class="lead">
                                        <?php echo $row['Ending_Hours'] ;?></p>
                                </div>
                            </div>
                        </div>
                    </div>
